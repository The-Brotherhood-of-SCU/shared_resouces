      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(controller:kcmC,decoration: InputDecoration(labelText: "课程名",icon: Icon(Icons.book)),),
            TextField(controller:kchC,decoration: InputDecoration(labelText: "课程号",icon: Icon(Icons.numbers)),),
